/*--- Platform page 045 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img8[1]=new Image();Img8[1].src='images/ady_builders_back-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
