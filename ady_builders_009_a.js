...
function OnWeLoad()
{
	...
	Img9={max:1,pos:0};
	Img9[0]=new Image();Img9[0].src='images/button1.gif';
	Img9[1]=new Image();Img9[1].src='images/button2.gif';
	Img11={max:1,pos:0,grp:'12'};
	Img11[0]=new Image();Img11[0].src='images/square.gif';
	Img11[1]=new Image();Img11[1].src='images/ady_builders_next-button.gif';
	Img13={max:1,pos:0,grp:'14'};
	Img13[0]=new Image();Img13[0].src='images/square.gif';
	Img13[1]=new Image();Img13[1].src='images/ady_builders_back-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
