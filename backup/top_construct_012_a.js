...
function OnWeLoad()
{
	...
	Img10={max:1,pos:0};
	Img10[0]=new Image();Img10[0].src='images/top_construct012003.gif';
	Img10[1]=new Image();Img10[1].src='images/top_construct012004.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
