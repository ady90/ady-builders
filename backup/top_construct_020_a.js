/*--- Platform page 020 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img9[1]=new Image();Img9[1].src='images/top_construct_back-button.gif';
	Img11={max:1,pos:0,grp:'12'};
	Img11[0]=new Image();Img11[0].src='images/square.gif';
	Img11[1]=new Image();Img11[1].src='images/top_construct_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
