/*--- Platform page 001 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img1[1]=new Image();Img1[1].src='images/top_construct_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
