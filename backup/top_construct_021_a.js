/*--- Platform page 021 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img6[1]=new Image();Img6[1].src='images/top_construct_back-button.gif';
	Img8={max:1,pos:0,grp:'9'};
	Img8[0]=new Image();Img8[0].src='images/square.gif';
	Img8[1]=new Image();Img8[1].src='images/top_construct_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
