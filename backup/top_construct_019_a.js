/*--- Platform page 019 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img5[1]=new Image();Img5[1].src='images/top_construct_back-button.gif';
	Img7={max:1,pos:0,grp:'8'};
	Img7[0]=new Image();Img7[0].src='images/square.gif';
	Img7[1]=new Image();Img7[1].src='images/top_construct_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
