/*--- Platform page 011 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img4[1]=new Image();Img4[1].src='images/top_construct_next-button.gif';
	Img6={max:1,pos:0,grp:'7'};
	Img6[0]=new Image();Img6[0].src='images/square.gif';
	Img6[1]=new Image();Img6[1].src='images/top_construct_back-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
