/*--- Platform page 004 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img10[1]=new Image();Img10[1].src='images/ady_builders_next-button.gif';
	Img12={max:1,pos:0,grp:'13'};
	Img12[0]=new Image();Img12[0].src='images/square.gif';
	Img12[1]=new Image();Img12[1].src='images/ady_builders_back-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
