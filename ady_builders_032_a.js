/*--- Platform page 032 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img9[1]=new Image();Img9[1].src='images/ady_builders_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
