...
function OnWeLoad()
{
	...
	Img3={max:1,pos:0};
	Img3[0]=new Image();Img3[0].src='images/button1.gif';
	Img3[1]=new Image();Img3[1].src='images/button2.gif';
	Img10={max:1,pos:0,grp:'11'};
	Img10[0]=new Image();Img10[0].src='images/square.gif';
	Img10[1]=new Image();Img10[1].src='images/ady_builders_back-button.gif';
	Img12={max:1,pos:0,grp:'13'};
	Img12[0]=new Image();Img12[0].src='images/square.gif';
	Img12[1]=new Image();Img12[1].src='images/ady_builders_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
