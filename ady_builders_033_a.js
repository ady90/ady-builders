/*--- Platform page 033 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img4={max:1,pos:0};
	Img4[0]=new Image();Img4[0].src='images/button1.gif';
	Img4[1]=new Image();Img4[1].src='images/button2.gif';
	Img8={max:1,pos:0,grp:'9'};
	Img8[0]=new Image();Img8[0].src='images/square.gif';
	Img8[1]=new Image();Img8[1].src='images/ady_builders_back-button.gif';
	Img10={max:1,pos:0,grp:'11'};
	Img10[0]=new Image();Img10[0].src='images/square.gif';
	Img10[1]=new Image();Img10[1].src='images/ady_builders_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
