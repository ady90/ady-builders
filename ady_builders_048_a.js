...
function OnWeLoad()
{
	...
	Img2[1]=new Image();Img2[1].src='images/ady_builders_back-button.gif';
	Img4={max:1,pos:0,grp:'5'};
	Img4[0]=new Image();Img4[0].src='images/square.gif';
	Img4[1]=new Image();Img4[1].src='images/ady_builders_next-button.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
