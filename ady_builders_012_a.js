/*--- Platform page 012 Motion Java Script ---*/
...
function OnWeLoad()
{
	...
	Img7[1]=new Image();Img7[1].src='images/ady_builders_back-button.gif';
	Img10={max:1,pos:0};
	Img10[0]=new Image();Img10[0].src='images/button1.gif';
	Img10[1]=new Image();Img10[1].src='images/button2.gif';	IDP.my=(window.parent.frames.length && parent.MyFrm)?parent.MyFrm:window;
